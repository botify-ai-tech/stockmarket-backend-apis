...
# @ratio_router.get("/company-symbol/")
# def get_company_symbol(company_name: str):

#     attribute_name = company_name.replace(" ", "_").replace(".", "").replace("&", "and")

#     symbol = getattr(Company, attribute_name, None)

#     if not symbol:
#         # If the symbol is not found, return a 404 error
#         raise HTTPException(status_code=404, detail="Company not found")

#     return {"company_name": company_name, "symbol": symbol}
